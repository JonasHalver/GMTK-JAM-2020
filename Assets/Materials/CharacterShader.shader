	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Details = float4(IN.ase_texcoord3.xy,0,0).xy * _Details_ST.xy + _Details_ST.zw;
				float4 tex2DNode3 = tex2D( _Details, uv_Details );
				float2 uv_Lights = float4(IN.ase_texcoord3.xy,0,0).xy * _Lights_ST.xy + _Lights_ST.zw;
				float4 color12 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_RimLight = float4(IN.ase_texcoord3.xy,0,0).xy * _RimLight_ST.xy + _RimLight_ST.zw;
				...
				float3 Color = ( tex2DNode1 + ( tex2DNode3 * tex2DNode3.a ) + ( tex2D( _Lights, uv_Lights ).a * _LightColor ) + staticSwitch10 ).rgb;
...
/*ASEBEGIN
Version=18200
243;391;1215;415;902.2759;463.2068;1.722192;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;10;-320.3459,300.0228;Inherit;True;Property;_RimLightFlash;RimLightFlash;4;0;Create;True;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;23;3;1;4
ASEEND*/
//CHKSM=42B607BDD302E51D1E6D8A4398B2311165104910